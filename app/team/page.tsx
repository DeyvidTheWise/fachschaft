...
export default function TeamPage() {
  ...
  const teamMembers = [
    ...
    },
    {
      ...
      image: "/images/gergana-dimitrova.png",
    ...
    },
    {
      ...
      image: "/images/yordan-ivanov.png",
    ...
    },
    {
      ...
      image: "/images/martin-kirilov.png",
    ...
    },
    {
      ...
      image: "/images/alexandar-hristov.png",
  ...
  return (
    <div className="container mx-auto px-4 py-12">
      <div className="max-w-3xl mx-auto text-center mb-12">
        <h1 className="text-4xl font-bold tracking-tight mb-4 text-primary">{t("meet_our_team_title")}</h1>
          ...
          <Card key={member.id} className="overflow-hidden hover:shadow-lg transition-shadow">
            ...
            <CardHeader>
              <div className="flex justify-between items-start">
                ...
                <Badge variant="outline" className="border-primary text-primary min-w-[80px] text-center">
                  {member.year}
                </Badge>
              </div>
            </CardHeader>
            ...
            <CardFooter className="flex gap-4">
              ...
              <button disabled className="text-muted-foreground/50 cursor-not-allowed" title="Coming soon">
